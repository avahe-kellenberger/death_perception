...
pub fn Map(comptime width: usize, comptime height: usize) type {
    return struct {
        ...
        fn compareRooms(_: void, a: Room, b: Room) bool {
...
test {
    ...
    var map = try Map(100, 100).init(std.heap.smp_allocator, 32, 46.0, 4);
    defer map.deinit();
